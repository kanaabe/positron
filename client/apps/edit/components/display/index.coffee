...
displayFormTemplate = -> require('./form.pug') arguments...
magazinePreview = -> require('./templates/magazine_preview.pug') arguments...
socialPreview = -> require('./templates/social_preview.pug') arguments...
searchPreview = -> require('./templates/search_preview.pug') arguments...
emailPreview = -> require('./templates/email_preview.pug') arguments...
